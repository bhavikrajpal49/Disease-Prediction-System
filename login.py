...
class Login:
   ...
   def Register(self):
      ...
      Frame_login1.place(x=0,y=0,height=1050,width=1550)

      

      self.img=ImageTk.PhotoImage(file="bg1500.png")
      img=Label(Frame_login1,image=self.img).place(x=0,y=0,width=1500,height=1050)
      ...
      label5=Label(frame_input2,text="Confirm Password",
                   font=("Goudy old style",20,"bold"),fg='#00B7EB',bg='white')
      ...
      btn2=Button(frame_input2,command=self.register,text="Register"
                  ...
                  bg="#00B7EB",bd=0,width=15,height=1)
